...
use Augias\ApiBundle\State\Processor\InvoiceLinePersistProcessor;
...
#[ORM\DiscriminatorMap(['invoice' => Line::class, 'recurring_invoice' => RecurringInvoiceLine::class, 'credit_note' => CreditNoteLine::class])]
#[ApiResource(
