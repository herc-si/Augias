...
/**
 * The account of who looked at a company's data, kept where it can be checked.
 *
 ...
 * whose very shape lives only in a host's private tooling is one they cannot
 * check. The screen that reads it is the operator console's.
 *
